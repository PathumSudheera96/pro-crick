...
export function Cta() {
  return (
    <section className="mx-auto max-w-[90rem] px-5 pb-10 pt-24 sm:px-8 lg:px-10">
      <div className="grid overflow-hidden border border-hairline bg-surface lg:grid-cols-[1.05fr_0.95fr]">
        <div className="p-7 sm:p-10 lg:p-14">
          <p className="type-accent uppercase text-muted">Final call to action</p>
          <h2 className="type-h2 mt-4 max-w-2xl text-foreground">
