...
export default async function PlayerProfilePage({ params }: PlayerPageProps) {
  ...
  return (
    <>
      ...
      <main>
        <section className="overflow-hidden bg-surface px-5 py-20 sm:px-8 lg:px-10">
          <div className="mx-auto grid max-w-[90rem] items-center gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-8 text-[clamp(2.25rem,5vw,4.875rem)] font-medium leading-[0.96] tracking-[-0.06em] text-foreground">
                {player.name}
              </h1>

              <dl className="mt-10 grid gap-5 text-foreground sm:grid-cols-2">
                <div>
              ...
              <p className="type-lead mt-8 max-w-xl text-muted">{player.profileLine}</p>
        ...
        <section className="bg-background px-5 py-24 sm:px-8 lg:px-10">
          <div className="mx-auto grid max-w-[90rem] gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="type-accent font-medium uppercase text-accent">Profile summary</p>
              <h2 className="type-h3 mt-4 max-w-xl text-foreground">
