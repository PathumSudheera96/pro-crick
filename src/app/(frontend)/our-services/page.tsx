    ...
    <>
      ...
      <main>
        <PageHero
          ...
          actions={[
            { href: '/contact-us', label: 'Talk to Pro-Crick' },
          ...
          <div className="mx-auto grid max-w-[90rem] gap-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="p-8 lg:p-10">
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                ...
                <Link
                  href="/contact-us"
                  className="inline-flex items-center justify-center gap-2 border border-foreground bg-transparent px-8 py-4 text-sm font-semibold uppercase tracking-[0.22em] text-foreground transition-colors hover:bg-foreground/5 hover:border-foreground/60"
                >
                  Contact Us
                </Link>
              </div>
